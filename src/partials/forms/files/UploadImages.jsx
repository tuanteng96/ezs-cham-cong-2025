...
const UploadImages = ({
  ...
  const onPhotoLibrary = () => {
    //f7.dialog.preloader("Đang thực hiện ..."); // Version mới của IOS mới bật

    const arg = {
      accept: accept, // "image/*", "image/png,image/jpeg", "video/*", "image/*,video/*"
    ...
    if (arg.isCompressed) arg.ext = "jpg";
